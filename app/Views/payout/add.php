        ...
        <div class="">
            <div class="page-header-title">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('Payout'); ?>">Payout</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php echo form_open('Payout/addnew', array('id' => 'addfrm', 'class' => '', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Member Number<span class="error">*</span></label>
                                                    <select class="form-control" name="member_id" id="member_id" >
                                                        ...
                                                        <?php foreach ($member as $l) { ?>
                                                            <option value="<?php echo $l['id']; ?>"><?php echo $l['member_no']; ?> (<?php echo $l['name']; ?>)</option>
                                                        <?php } ?>
                                                    </select>
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-t-10">Add Payout</button>
                                        <a class="btn btn-default waves-effect waves-light m-t-10" href="<?php echo base_url('Payout'); ?>">Cancel</a>
                                        <?php echo form_close(); ?>
                                    </div>
                                </div>
                            </div>
