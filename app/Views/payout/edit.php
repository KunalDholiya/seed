                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php echo form_open('Payout/editnew/'. base64_encode($info[0]['id']), array('id' => 'addfrm', 'class' => '', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Member Number<span class="error">*</span></label>
                                                    <select class="form-control" name="member_id" id="member_id">
                                                        ...
                                                        foreach ($member as $l) { ?>
                                                        <option value="<?php echo $l['id']; ?>" <?php if(in_array($l['id'], $member_id)){ echo 'selected'; }?>><?php echo $l['member_no']; ?> (<?php echo $l['name']; ?>)</option>
                                                        <?php } ?>
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Total amount planted to date<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="amount_planted_date" name="amount_planted_date" value="<?php echo $info[0]['amount_planted_date']; ?>" placeholder="Total amount planted to date">
                                                </div>
                                            </div>
                                            
                                        </div>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-t-10">Edit Payout</button>
