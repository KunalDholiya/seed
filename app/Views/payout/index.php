    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">Payout <a href="<?php echo site_url('Payout/add'); ?>" class="btn btn-primary waves-effect waves-light pull-right add-btn"><i class="fa fa-plus"></i> Add Payout</a></h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h5 class="tx-cen">Are you sure you want to <span id="new_status"></span> this Payout?</h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5 class="tx-cen">Are you sure you want to delete this Payout ?</h5>
    ...
    <script type="text/javascript">
        function load_transactiontable() {
            ...
            var table = jQuery('#transaction').DataTable({
                ...
                "order": [[0, "DESC"]],
                "ajax": {
                    url: "<?php echo site_url('Payout/gettabledata'); ?>",
                    data: function (d) {
                ...
                "columns": [
                    ...
                    {"taregts": 2, 'data': 'date_of_harvest',
                         "searchable": false,
                        "render": function (data, type, row) {
                    ...
                    {"taregts": 5, "searchable": false, "orderable": false, "sClass": "text-center",
                        "render": function (data, type, row) {
                            ...
                            out += '<a title="Edit"  href="<?php echo site_url('Payout/edit/'); ?>' + id + '"><i class="glyphicon glyphicon-edit btm-view"></i></a>&nbsp;';
        ...
        function update_status() {
            ...
            $.ajax({
                url: "<?php echo base_url() . '/Payout/update_status' ?>",
                type: "POST",
                dataType: "json",
        ...
        function resendpass() {
            ...
            $.ajax({
                url: "<?php echo base_url() . '/Payout/resendPass' ?>",
                type: "POST",
                dataType: "json",
        ...
        function deleterecord() {
            ...
            $.ajax({
                url: "<?php echo base_url() . '/Payout/delete' ?>",
                type: "POST",
                dataType: "json",
