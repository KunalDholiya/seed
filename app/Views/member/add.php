                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php echo form_open('Members/addnew', array('id' => 'addfrm', 'class' => '', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Member name<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Member name">
                                                </div>
                                            </div>
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-t-10">Add Member</button>
            ...
            jQuery("#addfrm").validate({
                rules: {
                    ...
                    email: {
                        ...
                        email: true,
                        remote: {
                            url: "<?php echo site_url('Members/emailExits') ?>",
                            type: "post",
                            data: {
                                email: function () {
                                    return $("#email").val();
