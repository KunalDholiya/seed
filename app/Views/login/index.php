...
<!--                <img src="<?php echo config('CustomConfig')->common_assets_path; ?>/images/sdn-logo.png" class="img-responsive sdn-logo-center">-->
            </div>
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-body">
                    ...
                    <?php echo form_open('login/authenticate', ['id' => 'loginfrm', 'class' => 'form-horizontal m-t-20', 'role' => 'form']); ?>
        ...
        <script src="<?php echo config('CustomConfig')->common_assets_path; ?>js/jquery.validate.min.js"></script>
