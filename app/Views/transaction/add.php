                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php echo form_open('Transaction/addnew', array('id' => 'addfrm', 'class' => '', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">week<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="week" name="week" placeholder="week">
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Date of seed<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="date_of_seed" name="date_of_seed" placeholder="Date of seed">
                                                </div>
                                            </div>
                                             <div class="clearfix"></div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Date of harvest<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="date_of_harvest" name="date_of_harvest" placeholder="Date of harvest">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Amount planted this week<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="amount_planted_week" name="amount_planted_week" placeholder="Amount planted this week">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Total amount planted to date<span class="error">*</span></label>
                                                    <input type="text" class="form-control" id="amount_planted_date" name="amount_planted_date" placeholder="Total amount planted to date">
                                                </div>
                                            </div>
                                              <div class="clearfix"></div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Amount of persons in harvesting this week</label>
                                                    <input type="text" class="form-control" id="week_per_person" name="week_per_person" placeholder="Amount of persons in harvesting this week">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Total harvest this week</label>
                                                    <input type="text" class="form-control" id="total_per_week" name="total_per_week" placeholder="Total harvest this week">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Church receives</label>
                                                    <input type="text" class="form-control" id="church_received" name="church_received" placeholder="Church receives">
                                                </div>
                                            </div>
                                               <div class="clearfix"></div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Members receives</label>
                                                    <input type="text" class="form-control" id="member_received" name="member_received" placeholder="Members receives">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group"> <label for="">Amount return to pool</label>
                                                    <input type="text" class="form-control" id="amount_return_to_pool" name="amount_return_to_pool" placeholder="Amount return to pool">
                                                </div>
                                            </div>
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-t-10">Add Transaction</button>
