    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">All Transactions Log</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('Dashboard'); ?>">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">All Transactions Log</li>
                    </ol>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function load_transactiontable() {
            ...
            var table = jQuery('#transaction').DataTable({
                ...
                "order": [[0, "DESC"]],
                "ajax": {
                    url: "<?php echo site_url('Report/gettabledata'); ?>",
                    data: function (d) {
...
//                    },
                ...
                buttons: [
                    {extend: 'excelHtml5', footer: true, text: 'Export Excel', filename: function () {
                            ...
                            return "transaction" + date + "_" + month + "_" + year;
                        },
                        messageTop: function () {
                            var out = "";
