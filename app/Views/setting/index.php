                                                    ...
                                                    <?php if (count($settings) > 0) { ?>
                                                        <?php for ($i = 0; $i < count($settings); $i++) { ?>   
                                                            <tr class="gradeX">
                                                                ...
                                                                <?php if ($settings[$i]['setting_id'] == 7) { ?>
                                                                <td><img src="<?php echo base_url().config('CustomConfig')->upload_path_logo_thumb.($settings[$i]['setting_value']); ?>" style="height:100px;"></td>
                                                                <?php } else { ?>
        ...
        <script type="text/javascript">
            function edit_setting(id)
            {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "html",
                    data: {'<?php echo csrf_token(); ?>': '<?php echo csrf_hash(); ?>', 'setting_id': setting_id, },
                    catch : false,
